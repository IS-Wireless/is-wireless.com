  ...
  <div class="w-full my-16">
    <client-only>
      <div v-swiper="swiperOptionsObject" class="swiper">
        ...
        <div
          tabindex="0"
          class="absolute group top-1/2 left-0 px-4 py-2 -mt-2 text-white bg-black bg-opacity-40 hover:bg-opacity-50 transition z-20"
          data-slide-prev
          role="button"
        >
          <svg
        ...
        <div
          tabindex="0"
          class="absolute group top-1/2 right-0 px-4 py-2 -mt-2 text-white bg-black bg-opacity-40 hover:bg-opacity-50 transition z-20"
          data-slide-next
          role="button"
        >
          <svg
