    ...
    >
      ...
      <ul v-if="data.socials" class="flex tablet:p-5 tablet:pr-0">
        <li v-for="item in data.socials" :key="item.type" class="block m-1.5">
          <div class="flex justify-center items-center w-8 h-8 hover:bg-opacity-70 transition rounded-md cursor-pointer"
            :class="{
            ...
            data-to=""
            data-title=""
            :data-sharer="item.type.replace('mail', 'email')"
            :data-url="'https://is-wireless.com' + route.fullPath"
            @click="handleClick($event)"
            >

            <svg v-if="item.type == 'facebook'"
              width="26"
              height="38"
              viewBox="-1 -16 26 65"
              fill="none"
            ...
            <svg v-else-if="item.type == 'twitter'"
              width="20"
              height="20"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <svg v-else-if="item.type == 'linkedin'"
              width="20"
              height="20"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
