<template>
    <section :class="mergeClass">
      ...
      >
        ...
        >
          <SectionHeader v-if="data.title" :title="data.title.replace('-', '‑')" class="relative z-20 text-gray-darkest" />
          <div class="relative z-20 tablet:p-[50px]">
            <div
              v-if="data.content"
  ...
  export default {
    name: 'section_two_column_gallery2',
    components: {
      SectionHeader,
      List,
    },
