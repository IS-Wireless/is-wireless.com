...
.content-html >>> ul li::before {
  ...
  @apply content-[''] w-6 h-6 tablet:w-10 tablet:h-10 bg-no-repeat inline-block relative mr-2 tablet:mr-5 top-2 tablet:top-2.5
}
.content-html >>> ul li {
  @apply mb-[30px] text-lg tablet:text-xl desktop:text-2xl text-gray-darkest
}
