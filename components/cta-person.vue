<template>
    <div class="relative z-10 w-full mb-20 tablet:mb-0 mt-10 tablet-wide:mt-0 tablet-wide:-translate-y-1/2 bg-blue-main flex flex-col tablet-small:flex-row justify-between items-stretch tablet-wide:gap-6 desktop:gap-14 rounded-[5px] shadow-2xl shadow-gray-dark/20 tablet:pl-10 tablet:pr-5 desktop:pr-20">
        <div class="flex flex-col tablet-wide:flex-row tablet-wide:gap-6 desktop:gap-14">
            ...
            <div class="px-5 tablet:px-0 pb-5 tablet:py-10">
        ...
        <div v-if="data.person" class="relative basis-[250px] shrink-0 grow-0">
            ...
            <div v-if="data.person.name" class="p-5 py-4 bg-white absolute left-5 tablet:left-[-30px] -bottom-9 w-full">
                ...
                <p v-if="data.person.below_name" class="text-gray-dark text-base tablet:text-lg">
                    {{ data.person.below_name }}
                </p>
...
.content-html >>> a[href^="mailto:"]{
    @apply block mb-3 text-2xl tablet:text-3xl desktop:text-4xl whitespace-nowrap
}

.content-html >>> a[href^="tel:"]{
    @apply block text-xl tablet:text-2xl whitespace-nowrap
