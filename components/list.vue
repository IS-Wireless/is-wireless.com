      ...
      <EffectAppear class="h-full">
        ...
        >
          ...
          <div
            ...
            :class="
              isTransparent
                ? 'text-white backdrop backdrop-blur-lg backdrop-brightness-100 backdrop-contrast-100 backdrop-grayscale-0 backdrop-hue-rotate-0 backdrop-invert-0 backdrop-opacity-100 backdrop-saturate-100 backdrop-sepia-0 bg-white/5 rounded-[5px]'
