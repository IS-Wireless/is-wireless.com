<template>
    <nav class="w-full relative bg-black border-0 border-b border-gray-main z-30">
            ...
            <div class="grow flex items-center justify-end">
                                ...
                                <li class="basis-1/4 grow-0 flex" v-for="subItem in item.children" :key="subItem.title">
                                    <div class="menu-sub-col">
                                        ...
                                        <ul class="flex flex-col mb-5">
                                            <li v-for="subSubItem in subItem.children" :key="subSubItem.title">
                                                <nuxt-link class="py-1.5 block text-sm text-white hover:text-blue-main transition" :to="subSubItem.url">{{subSubItem.title}}</nuxt-link> 
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                ...
                <ul class="h-full flex items-center">
                    <li class="navbar-item flex" @click="toggleExpanded">
                        <svg width="20" height="35" viewBox="12 0 25 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="navbar-item hidden tablet-wide:flex" @click="toggleMainSearch">
                        <svg width="16" height="16" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M24.8564 24.8563C25.0479 24.6647 25.0479 24.3545 24.8563 24.163L17.6572 16.9639L17.6867 16.9311C19.3076 15.1315 20.3038 12.7588 20.3038 10.1518C20.3037 4.55414 15.7496 0 10.1519 0C4.55414 0 0 4.55414 0 10.1519C0 15.7496 4.55414 20.3038 10.1519 20.3038C12.7588 20.3038 15.1315 19.3076 16.9312 17.6867L16.9639 17.6573L24.163 24.8563C24.2587 24.9521 24.3843 25 24.5097 25C24.6351 25 24.7606 24.9521 24.8564 24.8563ZM10.1519 19.323C5.09531 19.323 0.980748 15.209 0.980748 10.1519C0.980748 5.09482 5.09531 0.980687 10.1519 0.980687C15.2085 0.980687 19.323 5.09476 19.323 10.1519C19.323 15.209 15.2085 19.323 10.1519 19.323Z" fill="#FFFFFF"/>
                        </svg>
                    </li>
                </ul>
                <div class="absolute top-0 right-0 w-full h-full hidden tablet-wide:block pointer-events-none">
                    <div class=" mx-auto w-4/5 h-full flex overflow-hidden">
                        <span class="w-[200px] shrink-0"></span>
                        <form class=" flex flex-row h-full grow bg-[#111] transition duration-500 pointer-events-auto" :class="{'translate-x-full':!this.mainSearch}">
                            ...
                            <div class="px-5 h-full flex justify-center items-center cursor-pointer text-white hover:text-white/70" @click="toggleMainSearch">
                                <svg class="text-inherit fill-current transition" width="30" height="30" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <rect x="15" y="34.9373" width="28.1956" height="2.91679" rx="1" transform="rotate(-45 15 34.9373)" />
                                </svg>
                            </div>
                        </form>
                    </div>
        ...
        <div class="fixed flex z-40 top-0 left-0 w-full h-screen overflow-hidden" :class="{'pointer-events-none':!expanded}">
            <div class="w-full transition duration-500 " :class="{'bg-[#3F3F3F]/70':expanded}" @click="toggleExpanded"></div>
            <div class="absolute z-50 top-0 left-full w-full tablet-wide:w-[300px] h-screen bg-[#242424] transform transition duration-500" v-bind:class="{'-translate-x-full ':expanded}">
                <div class="w-8 ml-5 mt-3 cursor-pointer text-white hover:text-white/80" @click="toggleExpanded">
                    <svg class="text-inherit fill-current transition" width="30" height="30" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="17.0625" y="15.0002" width="28.1956" height="2.91678" rx="1" transform="rotate(45 17.0625 15.0002)" />
                        <rect x="15" y="34.9373" width="28.1956" height="2.91679" rx="1" transform="rotate(-45 15 34.9373)" />
                    </svg>
                ...
                <div class="px-7 tablet-wide:hidden">
                    <form class="mt-10 flex w-full border border-solid border-white focus-visible:outline-none">
                        <input type="search" placeholder="Search..." class=" px-5 grow bg-[#A7A7A7]/30 text-white focus-visible:outline-none">
                        <button type="submit" class="flex items-center justify-center w-[50px] h-[48px] bg-white text-[#555] hover:text-blue-main">
                            <svg class="fill-current transition" width="18" height="18" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M24.8564 24.8563C25.0479 24.6647 25.0479 24.3545 24.8563 24.163L17.6572 16.9639L17.6867 16.9311C19.3076 15.1315 20.3038 12.7588 20.3038 10.1518C20.3037 4.55414 15.7496 0 10.1519 0C4.55414 0 0 4.55414 0 10.1519C0 15.7496 4.55414 20.3038 10.1519 20.3038C12.7588 20.3038 15.1315 19.3076 16.9312 17.6867L16.9639 17.6573L24.163 24.8563C24.2587 24.9521 24.3843 25 24.5097 25C24.6351 25 24.7606 24.9521 24.8564 24.8563ZM10.1519 19.323C5.09531 19.323 0.980748 15.209 0.980748 10.1519C0.980748 5.09482 5.09531 0.980687 10.1519 0.980687C15.2085 0.980687 19.323 5.09476 19.323 10.1519C19.323 15.209 15.2085 19.323 10.1519 19.323Z"/>
                            </svg>
                        </button>
                    </form>
                ...
                <ul class="flex flex-col px-7 mt-10 ">
                    <li class="mb-3" v-for="items in sideMenu" v-bind:key="items.title" :class="{'tablet-wide:hidden':!items.desktop}">
                        <nuxt-link class="text-xl text-white hover:text-blue-main transition" to="">{{items.title}}</nuxt-link>
                    </li>
                    <!-- <li class="mb-3" v-for="items in menu" v-bind:key="items.title">
                        <nuxt-link class="text-xl text-white hover:text-blue-main transition" to="">{{items.title}}</nuxt-link>
                    </li> -->
                </ul>
            </div>
