<template>
    <nav class="w-full relative bg-black border-0 border-b border-gray-main">
        <div class="mx-auto w-4/5 flex justify-between">
            ...
            <div class="relative grow flex items-center justify-end">
                <ul class="h-full flex-shrink-0 hidden tablet-wide:flex items-center justify-end">
                    <li class="navbar-item flex group text-white" v-for="items in mainMenu" v-bind:key="items.title">
                        <nuxt-link class="text-base text-inherit" to="">{{items.title}}</nuxt-link> 
                    </li>
                </ul>
