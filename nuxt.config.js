    ...
    [
      '@aceforth/nuxt-netlify',
      {
        ...
        redirects: [
          ...
          {from: '/5g-6g-open-ran-testbed', to: '/academy/5g-6g-open-ran-testbed'},
          {from: '/5g-6g-open-ran-testbed/', to: '/academy/5g-6g-open-ran-testbed'},
          {from: '/networks/hardware/du-cu', to: '/networks/hardware'},
          {from: '/networks/hardware/du-cu/', to: '/networks/hardware'},
          {from: '/networks/hardware/indoor-ru', to: '/networks/hardware'},
          {from: '/networks/hardware/indoor-ru/', to: '/networks/hardware'},
          {from: '/networks/hardware/outdoor-ru', to: '/networks/hardware'},
          {from: '/networks/hardware/outdoor-ru/', to: '/networks/hardware'},
          {from: '/networks/software/4g-5g-core', to: '/networks/software'},
          {from: '/networks/software/4g-5g-core/', to: '/networks/software'},
          {from: '/networks/software/enodeb', to: '/networks/software'},
          {from: '/networks/software/enodeb/', to: '/networks/software'},
          {from: '/networks/software/gnodeb', to: '/networks/software'},
          {from: '/networks/software/gnodeb/', to: '/networks/software'},
          {from: '/networks/software/mano', to: '/networks/software'},
          {from: '/networks/software/mano/', to: '/networks/software'},
          {from: '/networks/software/ricxapps', to: '/networks/software'},
          {from: '/networks/software/ricxapps/', to: '/networks/software'}, 
        ],
      },
    ],
