  ...
  async asyncData({ route, payload, store, $config }) {
    return {
      pageData: {
        ...
        modified: '2022-09-09T11:33:55',
        modified_gmt: '2022-09-09T09:33:55',
        slug: 'public-funds',
        status: 'publish',
        type: 'page',
        ...
        schema_basic: {
          ...
          article_modified_time: '2022-09-09T09:33:55+00:00',
